...
const itemsSample = [
  {
    ...
    meta: "v2.4.1",
    description:
      "Real-time metrics with algorithm-based insights and predictive analytics",
    icon: <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-blue-500" />,
    status: "Live",
    tags: ["Statistics", "Reports", "Algorithms"],
    colSpan: 2,
        ...
        >
          ...
          <div className="relative flex flex-col space-y-2 sm:space-y-3 lg:space-y-4">
            ...
            <div className="space-y-1 sm:space-y-2">
              <h3 className="font-medium text-gray-900 dark:text-gray-100 tracking-tight text-sm sm:text-[15px] lg:text-base">
                {item.title}
