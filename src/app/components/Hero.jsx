    ...
    <section id="home" className="pt-20">
      <Card className="w-[95vw] md:w-[85vw] h-[80vh]  mx-auto overflow-hidden flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8 rounded-xl shadow-2xl">
        ...
        <div className="flex-1 flex flex-col justify-center z-10  py-6 sm:py-8 lg:py-10 order-2 lg:order-1">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 leading-tight tracking-tight text-center   xl:text-left">
            Futuristic Trading
          </h1>
          <p className="mt-3 sm:mt-4 md:mt-5 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-neutral-300 max-w-full text-center 2xl:text-left mx-auto leading-relaxed  ">
            Experience next-level trading with our AI-powered bot. Track
